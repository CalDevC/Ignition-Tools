"""
Fill in the constant variables at the top of this file with the 
information for your project and run the script in your project's 
script console.
"""
...
def updateAlarmTags(directory, attribute, new_value, alter_subdirectories):
	...
	for path in path_set:
		...
		if str(tag_info[u'tagType']) == 'Folder' and alter_subdirectories:
			updateAlarmTags(str(tag_info[u'path']), attribute, new_value)
